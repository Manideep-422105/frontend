...
const Rentals = () => {
  return (
    <div>
      ...
      <div className="absolute top-1 right-4 md:bottom-8 md:right-8 w-32 h-32 md:w-[530px] md:h-[530px]">
        <img
          src={blacklogo}
          alt="blacklogo"
      ...
      <div>
        <div class="flex flex-col gap-3 px-[620px]">
          ...
          {/* <button class="cursor-pointer">
            <div class="flex max-w-48 h-12 px-3 py-4 gap-2 rounded-xl items-center justify-center bg-black text-white dark:text-black dark:bg-white sm:h-14">
